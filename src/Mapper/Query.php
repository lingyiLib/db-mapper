...
class Query implements \Countable, \IteratorAggregate, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $_whereOperators = [
        '<' => 'lingyiLib\DbMapper\Mapper\Query\Operator\LessThan',
        ':lt' => 'lingyiLib\DbMapper\Mapper\Query\Operator\LessThan',
        '<=' => 'lingyiLib\DbMapper\Mapper\Query\Operator\LessThanOrEqual',
        ':lte' => 'lingyiLib\DbMapper\Mapper\Query\Operator\LessThanOrEqual',
        '>' => 'lingyiLib\DbMapper\Mapper\Query\Operator\GreaterThan',
        ':gt' => 'lingyiLib\DbMapper\Mapper\Query\Operator\GreaterThan',
        '>=' => 'lingyiLib\DbMapper\Mapper\Query\Operator\GreaterThanOrEqual',
        ':gte' => 'lingyiLib\DbMapper\Mapper\Query\Operator\GreaterThanOrEqual',
        '~=' => 'lingyiLib\DbMapper\Mapper\Query\Operator\RegExp',
        '=~' => 'lingyiLib\DbMapper\Mapper\Query\Operator\RegExp',
        ':regex' => 'lingyiLib\DbMapper\Mapper\Query\Operator\RegExp',
        ':like' => 'lingyiLib\DbMapper\Mapper\Query\Operator\Like',
        ':fulltext' => 'lingyiLib\DbMapper\Mapper\Query\Operator\FullText',
        ':fulltext_boolean' => 'lingyiLib\DbMapper\Mapper\Query\Operator\FullTextBoolean',
        'in' => 'lingyiLib\DbMapper\Mapper\Query\Operator\In',
        ':in' => 'lingyiLib\DbMapper\Mapper\Query\Operator\In',
        '<>' => 'lingyiLib\DbMapper\Mapper\Query\Operator\Not',
        '!=' => 'lingyiLib\DbMapper\Mapper\Query\Operator\Not',
        ':ne' => 'lingyiLib\DbMapper\Mapper\Query\Operator\Not',
        ':not' => 'lingyiLib\DbMapper\Mapper\Query\Operator\Not',
        '=' => 'lingyiLib\DbMapper\Mapper\Query\Operator\Equals',
        ':eq' => 'lingyiLib\DbMapper\Mapper\Query\Operator\Equals',
    ];
    ...
    public function count()
    {
        ...
        $stmt = $countCopy->select('COUNT(*)')->resetQueryPart('orderBy')->executeQuery();
        return (int)Arr::get($stmt->fetchFirstColumn(),0);
    }
