...
abstract class Entity implements EntityInterface, \JsonSerializable
{
    ...
    public static function table($tableName = null)
    {
        if (null !== $tableName) {
            ...
            $tableName = strtolower(Str::snake(Str::pluralStudly(class_basename(new static())), '_'));
            return config('databases.prefix').$tableName;
        }
        return static::$table;
    }
     ...
     *
     * @param \lingyiLib\DbMapper\Mapper\EventEmitter $eventEmitter
     */
     ...
     * Return defined fields of the entity
     *
     * @param \lingyiLib\DbMapper\Mapper\MapperInterface $mapper
