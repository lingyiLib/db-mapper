<?php
namespace lingyiLib\DbMapper\Mapper\Entity;


/**
 * Entity Manager for storing information about entities
 *
 * @package lingyiLib\DbMapper\Mapper\Entity
 * @author Vance Lucas <vance@vancelucas.com>
 */
class Manager
{
    /**
     * @var string|\lingyiLib\DbMapper\Mapper\Entity
     */
     ...
     * @param string|\lingyiLib\DbMapper\Mapper\Entity $entityName
     * @throws \lingyiLib\DbMapper\Mapper\Exception
     */
    public function __construct($entityName)
    {
        if (!is_string($entityName)) {
            throw new \lingyiLib\DbMapper\Mapper\Exception(__METHOD__ . " only accepts a string. Given (" . gettype($entityName) . ")");
        }

        if (!is_subclass_of($entityName, 'lingyiLib\DbMapper\Mapper\Entity')) {
            throw new \lingyiLib\DbMapper\Mapper\Exception($entityName . " must be subclass of '\lingyiLib\DbMapper\Mapper\Entity'.");
        }
