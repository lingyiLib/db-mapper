 ...
 *
 * @package lingyiLib\DatabaseSpot\Entity
...
class Collection implements \Iterator, \Countable, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @return \lingyiLib\DbMapper\Mapper\Entity The first result in the set
     */
     ...
     *
     * @param \lingyiLib\DbMapper\Mapper\Entity $entity to add
     */
     ...
     * collection
     *
     * @param \lingyiLib\DbMapper\Mapper\Entity\Collection $collection
