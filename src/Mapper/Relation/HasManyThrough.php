<?php
namespace lingyiLib\DbMapper\Mapper\Relation;

use lingyiLib\DbMapper\Mapper\Mapper;
use lingyiLib\DbMapper\Mapper\Entity;
use lingyiLib\DbMapper\Mapper\EntityInterface;
use lingyiLib\DbMapper\Mapper\Entity\Collection;
...
class HasManyThrough extends RelationAbstract implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @param \lingyiLib\DbMapper\Mapper\Entity\Collection
     */
     ...
     * Build query object
     *
     * @return \lingyiLib\DbMapper\Mapper\Query
     */
     ...
     * @param \lingyiLib\DbMapper\Mapper\Entity\Collection Collection of original entities to map results of query back to
     *
     * @return \lingyiLib\DbMapper\Mapper\Entity\Collection
     */
    public function eagerLoadOnCollection($relationName, $fields,Collection $collection)
    {
